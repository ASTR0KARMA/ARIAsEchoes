...
namespace NoaDebugger
{
    sealed class BatteryModel : ModelBase
    {
        ...
        public BatteryModel()
        {
            ...
            BatteryInfo.SetIsProfiling(BatteryModel.DefaultIsProfiling);
            _HandleOnUpdate(BatteryModel.DefaultIsProfiling);
        }
        ...
        {
            bool isProfiling = BatteryInfo?.IsProfiling ?? DefaultIsProfiling;
