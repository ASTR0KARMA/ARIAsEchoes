...
namespace NoaDebugger
{
    sealed class ThermalModel : ModelBase
    {
        ...
        static readonly bool DefaultIsProfiling = false;
...
#pragma warning restore
        ...
        {
            _ResetThermalInfo();
            ThermalInfo.SetIsProfiling(ThermalModel.DefaultIsProfiling);
            _HandleOnUpdate(ThermalModel.DefaultIsProfiling);
        }
        ...
        {
            bool isProfiling = ThermalInfo?.IsProfiling ?? ThermalModel.DefaultIsProfiling;
