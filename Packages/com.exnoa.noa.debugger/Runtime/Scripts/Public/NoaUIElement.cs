...
namespace NoaDebugger
{
    ...
    public static class NoaUIElement
    {
        ...
        {
            NoaDebuggerVisibilityManager.SetAllUIElementsVisibleSetting(visible);
        }
        ...
        /// <summary>
        /// Sets the anchor position alignment to vertical orientation.
        /// </summary>
        /// <param name="anchorType">Target AnchorType</param>
        public static void SetVerticalAlignment(AnchorType anchorType)
        {
            NoaDebuggerManager.SetVerticalAlignment(anchorType);
        }

        /// <summary>
        /// Sets the anchor position alignment to horizontal orientation.
        /// </summary>
        /// <param name="anchorType">Target AnchorType</param>
        public static void SetHorizontalAlignment(AnchorType anchorType)
        {
            NoaDebuggerManager.SetHorizontalAlignment(anchorType);
        }
    }
