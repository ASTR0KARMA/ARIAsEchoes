...
namespace NoaDebugger
{
    ...
    public abstract class LogEntry<TLogDetail> where TLogDetail : ILogDetail
    {
        ...
        /// <summary>
        /// Whether the log has already been displayed.
        /// </summary>
        internal bool HasLoggedOnce { set; get; }
        ...
        /// </summary>
        public bool IsSelecting { set; get; } = false;
        ...
        internal LogEntry(int serialNumber, string logString, string logViewString, LogType logType, DateTime receivedAt)
        {
            LogString = logString;
