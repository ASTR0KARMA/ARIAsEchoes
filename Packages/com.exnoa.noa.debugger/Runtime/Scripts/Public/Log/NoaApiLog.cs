...
namespace NoaDebugger
{
    ...
    public sealed class NoaApiLog
    {
        ...
        /// <param name="apiLogCallbacks">A class implementing INoaApiLogDownloadCallbacks or derived from NoaApiLogDownloadCallbacks</param>
        public static void SetDownloadCallbacks(INoaDownloadCallbacks commonCallbacks, INoaApiLogDownloadCallbacks apiLogCallbacks)
        {
            CommonDownloadCallbacks = commonCallbacks;
            ApiLogDownloadCallbacks = apiLogCallbacks;
        }

        internal static INoaDownloadCallbacks CommonDownloadCallbacks { get; private set; } = null;

        internal static INoaApiLogDownloadCallbacks ApiLogDownloadCallbacks { get; private set; } = null;
        ...
        /// </summary>
        [Obsolete("Inherit from NoaApiLogDownloadCallbacks and override OnBeforeConversion instead.")]
        public static Func<string, List<ApiLogEntry>, bool> OnLogDownloadWithLogEntries
        {
            get
            {
                var presenter = NoaDebugger.GetPresenter<ApiLogPresenter>();
        ...
        /// </summary>
        public static UnityAction<List<ApiLogEntry>> OnLogSend
        {
            get
            {
                var presenter = NoaDebugger.GetPresenter<ApiLogPresenter>();
