...
namespace NoaDebugger
{
    ...
    /// </summary>
    public interface INoaApiLogDownloadCallbacks
    {
        /// <summary>
        ...
        IReadOnlyList<ApiLogEntry> OnBeforeConversion(IReadOnlyList<ApiLogEntry> logEntries);
    }
    ...
    /// </summary>
    public class NoaApiLogDownloadCallbacks : INoaDownloadCallbacks, INoaApiLogDownloadCallbacks
    {
        /// <summary>
        ...
        /// <summary>
        /// See <see cref="INoaApiLogDownloadCallbacks.OnBeforeConversion"/> for details.
        /// </summary>
        public virtual IReadOnlyList<ApiLogEntry> OnBeforeConversion(IReadOnlyList<ApiLogEntry> logEntries)
        {
            return logEntries;
        }
