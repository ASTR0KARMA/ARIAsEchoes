...
namespace NoaDebugger
{
    ...
    public class NoaSnapshot
    {
        ...
        /// </summary>
        /// <param name="callbacks">A class implementing INoaDownloadCallbacks or derived from NoaDownloadCallbacks</param>
        public static void SetDownloadCallbacks(INoaDownloadCallbacks callbacks)
        {
