...
namespace NoaDebugger
{
    ...
    public sealed class DisplayInfo
    {
        ...
        /// <summary>
        /// Terminal's fullscreen mode
        /// </summary>
        public string FullscreenMode { private set; get; }
        ...
        internal void Refresh()
        {
            ...
            FullscreenMode = _GetFullscreenModeString();
        }
        ...
        /// <summary>
        /// Gets the terminal fullscreen mode
        /// </summary>
        /// <returns>Returns the terminal fullscreen mode string</returns>
        string _GetFullscreenModeString()
        {
            ...
            if (isCurrentlyFullScreen)
            {
                return currentMode switch
                {
                    ...
                    FullScreenMode.Windowed => "Windowed (Full)",
                    _ => null
                };
            }
            return $"Windowed (Mode: {currentMode})";
#else
            return null;
#endif
        }
