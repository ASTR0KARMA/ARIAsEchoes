...
namespace NoaDebugger.DebugCommand
{
    abstract class MutableNumericPropertyCommandBuilderBase<T> : MutablePropertyCommandBuilderBase<T> where T : struct
    {
        ...
        protected MutableNumericPropertyCommandBaseInfo<T> CreateNumericInfo()
        {
            return new MutableNumericPropertyCommandBaseInfo<T>(_inputRangeMin, _inputRangeMax, _increment);
        }
    }
}
