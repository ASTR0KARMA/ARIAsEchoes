...
namespace NoaDebugger.DebugCommand
{
    abstract class CommandBuilderBase
    {
        ...
        protected bool? IsCollapsedDefault { get; private set; }
            ...
            if (_attributes != null)
            {
                foreach (Attribute attribute in _attributes)
                {
                    if (attribute is CommandGroupAttribute group)
                    {
                        ...
                        IsCollapsedDefault = group._isCollapsedDefault;
                    }
        ...
        protected CommandBaseInfo CreateCommandInfo()
        {
            return new CommandBaseInfo(DisplayName, GroupName, GroupOrder, IsCollapsedDefault, TagName, Description, Order);
        }
    }
}
