...
namespace NoaDebugger.DebugCommand
{
    sealed class DoublePropertyCommand : MutableNumericPropertyCommandBase<double>
    {
        ...
        public DoublePropertyCommand(
            ...
            MutablePropertyCommandBaseInfo<double> mutableInfo,
            MutableNumericPropertyCommandBaseInfo<double> numericInfo,
            int needDigits = 0)
            : base(info, mutableInfo, numericInfo)
        {
            _inputRangeMin = numericInfo._inputRangeMin ?? DoublePropertyCommand.DEFAULT_INPUT_RANGE_MIN;
            _inputRangeMax = numericInfo._inputRangeMax ?? DoublePropertyCommand.DEFAULT_INPUT_RANGE_MAX;
            Increment = numericInfo._increment ?? DoublePropertyCommand.DEFAULT_INCREMENT;
