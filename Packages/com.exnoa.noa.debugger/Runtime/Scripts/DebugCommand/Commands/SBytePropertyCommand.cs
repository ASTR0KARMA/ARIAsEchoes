...
namespace NoaDebugger.DebugCommand
{
    sealed class SBytePropertyCommand : MutableNumericPropertyCommandBase<sbyte>
    {
        ...
        public SBytePropertyCommand(
            ...
            MutablePropertyCommandBaseInfo<sbyte> mutableInfo,
            MutableNumericPropertyCommandBaseInfo<sbyte> numericInfo)
            : base(info, mutableInfo, numericInfo)
        {
            _inputRangeMin = numericInfo._inputRangeMin ?? SBytePropertyCommand.DEFAULT_INPUT_RANGE_MIN;
            _inputRangeMax = numericInfo._inputRangeMax ?? SBytePropertyCommand.DEFAULT_INPUT_RANGE_MAX;
            Increment = numericInfo._increment ?? SBytePropertyCommand.DEFAULT_INCREMENT;
