...
namespace NoaDebugger.DebugCommand
{
    sealed class DecimalPropertyCommand : MutableNumericPropertyCommandBase<decimal>
    {
        ...
        public DecimalPropertyCommand(
            ...
            MutablePropertyCommandBaseInfo<decimal> mutableInfo,
            MutableNumericPropertyCommandBaseInfo<decimal> numericInfo,
            int needDigits = 0)
            : base(info, mutableInfo, numericInfo)
        {
            _inputRangeMin = numericInfo._inputRangeMin ?? DecimalPropertyCommand.DEFAULT_INPUT_RANGE_MIN;
            _inputRangeMax = numericInfo._inputRangeMax ?? DecimalPropertyCommand.DEFAULT_INPUT_RANGE_MAX;
            Increment = numericInfo._increment ?? DecimalPropertyCommand.DEFAULT_INCREMENT;
