...
namespace NoaDebugger.DebugCommand
{
    sealed class UIntPropertyCommand : MutableNumericPropertyCommandBase<uint>
    {
        ...
        public UIntPropertyCommand(
            ...
            MutablePropertyCommandBaseInfo<uint> mutableInfo,
            MutableNumericPropertyCommandBaseInfo<uint> numericInfo)
            : base(info, mutableInfo, numericInfo)
        {
            _inputRangeMin = numericInfo._inputRangeMin ?? UIntPropertyCommand.DEFAULT_INPUT_RANGE_MIN;
            _inputRangeMax = numericInfo._inputRangeMax ?? UIntPropertyCommand.DEFAULT_INPUT_RANGE_MAX;
            Increment = numericInfo._increment ?? UIntPropertyCommand.DEFAULT_INCREMENT;
