...
namespace NoaDebugger.DebugCommand
{
    sealed class ULongPropertyCommand : MutableNumericPropertyCommandBase<ulong>
    {
        ...
        public ULongPropertyCommand(
            ...
            MutablePropertyCommandBaseInfo<ulong> mutableInfo,
            MutableNumericPropertyCommandBaseInfo<ulong> numericInfo)
            : base(info, mutableInfo, numericInfo)
        {
            _inputRangeMin = numericInfo._inputRangeMin ?? ULongPropertyCommand.DEFAULT_INPUT_RANGE_MIN;
            _inputRangeMax = numericInfo._inputRangeMax ?? ULongPropertyCommand.DEFAULT_INPUT_RANGE_MAX;
            Increment = numericInfo._increment ?? ULongPropertyCommand.DEFAULT_INCREMENT;
