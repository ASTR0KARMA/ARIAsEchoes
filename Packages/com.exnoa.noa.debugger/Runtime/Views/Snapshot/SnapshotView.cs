...
namespace NoaDebugger
{
    sealed class SnapshotView : NoaDebuggerToolViewBase<SnapshotViewLinker>
    {
        ...
        [SerializeField]
        DisableButtonBase _allClearButton;
        ...
        [SerializeField]
        DisableButtonBase _comparisonButton;
        ...
        protected override void _Init()
        {
            ...
            _allClearButton._onClick.RemoveAllListeners();
            _allClearButton._onClick.AddListener(_OnClickAllClearButton);
            _downloadButton._onClick.RemoveAllListeners();
            _downloadButton._onClick.AddListener(_OnClickDownloadButton);
            _takeButton.onClick.RemoveAllListeners();
            _takeButton.onClick.AddListener(_OnClickTakeButton);
            _comparisonButton._onClick.RemoveAllListeners();
            _comparisonButton._onClick.AddListener(_OnClickComparisonButton);
        ...
        void _ShowByLogDataList(List<SnapshotLogRecordInformation> logDataList, bool isNeedResetScrollPos)
        {
            ...
            _downloadButton.Interactable = hasLogData && FileDownloader.CanDownload();
