...
namespace NoaDebugger
{
    sealed class ApiLogDetailView : MonoBehaviour
    {
        ...
        [SerializeField]
        NoaDebuggerText _responseBodyText;
        ...
        void Awake()
        {
            ...
            Assert.IsNotNull(_responseBodyText);
        ...
        public void ResetContent()
        {
            ...
            _responseBodyText.gameObject.SetActive(false);
        ...
        public void UpdateResponseTab(ApiLog log)
        {
            ...
            _responseBodyText.gameObject.SetActive(isShowResponseBody);

            if (isShowResponseBody)
            {
                _responseBodyText.text = NoaDebuggerText.GetHasFontAssetString(_responseBodyText.font, log.PrettyPrintedResponseBody);
            }
        }
