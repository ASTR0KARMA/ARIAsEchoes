...
namespace NoaDebugger.DebugCommand
{
        ...
        where TNumericType : struct
    {
        ...
        protected CommandPanelNumericInputPropertyBase(DebugCommandPanel panel) : base(panel)
        {
            ...
            panel._leftArrowButton._onPointerExit.RemoveAllListeners();
            panel._leftArrowButton._onPointerExit.AddListener(_OnExitArrowButton);
            panel._leftArrowButton.onClick.RemoveAllListeners();
            panel._leftArrowButton.onClick.AddListener(_OnClickLeftArrowButton);
            ...
            panel._rightArrowButton._onPointerExit.RemoveAllListeners();
            panel._rightArrowButton._onPointerExit.AddListener(_OnExitArrowButton);
            panel._rightArrowButton.onClick.RemoveAllListeners();
            panel._rightArrowButton.onClick.AddListener(_OnClickRightArrowButton);
