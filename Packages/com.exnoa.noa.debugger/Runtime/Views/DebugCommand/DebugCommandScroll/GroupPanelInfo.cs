...
namespace NoaDebugger.DebugCommand
{
    ...
    sealed class GroupCollapseToggleInfo
    {
        ...
        readonly public UnityAction<string, bool> _onClick;

        readonly public UnityAction<bool> _onLongTap;

        public GroupCollapseToggleInfo(bool isOn, UnityAction<string, bool> onClick, UnityAction<bool> onLongTap)
        {
            _isOn = isOn;
            _onClick = onClick;
