...
namespace NoaDebugger.DebugCommand
{
    sealed class CommandGroupPanel : UIBehaviour
    {
        ...
        [SerializeField] LongTapButton _collapseButton;
        [SerializeField] GameObject _openedObject;
        [SerializeField] GameObject _collapsedObject;
        ...
        void _Init()
        {
            ...
            _collapseButton._onPointerClick.AddListener(_OnClickCollapseToggle);
            _collapseButton._onLongTap.AddListener(_OnLongTapCollapseToggle);
        ...
        public void RefreshHeader(GroupPanelInfo group, bool isFloatingWindow, float headerHeight)
        {
            ...
            _SetCollapseButtonImage(group._collapseToggleInfo._isOn);
        }
        ...
        void _SetCollapseButtonImage(bool isCollapse)
        {
            _openedObject.SetActive(!isCollapse);
            _collapsedObject.SetActive(isCollapse);
        }
        ...
        void _OnClickCollapseToggle()
        {
            bool isOn = !_group._collapseToggleInfo._isOn;

            _group._collapseToggleInfo._isOn = isOn;
            _group._collapseToggleInfo._onClick?.Invoke(_group._name, isOn);

            _SetCollapseButtonImage(isOn);

            _CollapseCommands(isOn);
        }

        void _OnLongTapCollapseToggle()
        {
            bool isOn = !_group._collapseToggleInfo._isOn;

            _group._collapseToggleInfo._onLongTap?.Invoke(isOn);
        }
