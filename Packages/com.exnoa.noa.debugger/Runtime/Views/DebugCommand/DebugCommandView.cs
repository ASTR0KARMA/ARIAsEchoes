...
namespace NoaDebugger.DebugCommand
{
    sealed class DebugCommandView : NoaDebuggerToolViewBase<DebugCommandViewLinker>
    {
        ...
        [Header("Floating Select")]
        [SerializeField] GameObject _floatingSelectFooter;

        [SerializeField] Button _floatingSelectAllButton;
        [SerializeField] Button _floatingDeselectAllButton;
        ...
        public event UnityAction<bool> OnFloatingSelectAllButton;
        ...
        void _OnValidateUI()
        {
            ...
            Assert.IsNotNull(_floatingSelectFooter);
            Assert.IsNotNull(_floatingSelectAllButton);
            Assert.IsNotNull(_floatingDeselectAllButton);
        ...
        protected override void _Init()
        {
            ...
            _floatingSelectAllButton.onClick.RemoveAllListeners();
            _floatingSelectAllButton.onClick.AddListener(_OnTapFloatingSelectAllButton);
            _floatingDeselectAllButton.onClick.RemoveAllListeners();
            _floatingDeselectAllButton.onClick.AddListener(_OnTapFloatingDeselectAllButton);
            _detailsArea.Init();
        }
        ...
        protected override void _OnShow(DebugCommandViewLinker linker)
        {
            ...
            {
                bool isShowFloatingSelectFooter = linker._isActiveFloatingWindow &&
                                         linker._categoryNames is {Length: > 0} &&
                                         linker._groups is {Length: > 0};

                _floatingSelectFooter.SetActive(isShowFloatingSelectFooter);
            }
        ...
        void _OnTapFloatingSelectAllButton()
        {
            OnFloatingSelectAllButton?.Invoke(true);
        }

        void _OnTapFloatingDeselectAllButton()
        {
            OnFloatingSelectAllButton?.Invoke(false);
        }
    }
