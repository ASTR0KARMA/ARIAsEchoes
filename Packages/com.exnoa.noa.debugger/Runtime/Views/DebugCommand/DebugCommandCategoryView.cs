...
namespace NoaDebugger.DebugCommand
{
    sealed class DebugCommandCategoryView : ViewBase<DebugCommandViewLinker>
    {
        ...
        [SerializeField]
        DisableButtonBase _categorySelectButton;
        [SerializeField]
        ...
        protected override void _Init()
        {
            ...
            _categorySelectButton._onClick.RemoveAllListeners();
            _categorySelectButton._onClick.AddListener(_OnClickCategorySelect);
