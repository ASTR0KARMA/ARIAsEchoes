...
namespace NoaDebugger
{
    ...
    sealed class StackedAreaChart : MaskableGraphic
    {
        ...
        public void SetStackDisplayAttributesText(int index, string text)
        {
            _stackDisplayAttributes[index]._text = text;
            _legend.UpdateText(index, text);
        }

        public void SetStackDisplayAttributesColor(int index, Color newColor)
        {
            _stackDisplayAttributes[index]._color = newColor;
            _legend.UpdateColor(index, newColor);
        }

        public void SetStackDisplayAttributesShows(int index, bool shows)
        {
            _stackDisplayAttributes[index]._shows = shows;
            _legend.ToggleShow(index, shows);
        }
