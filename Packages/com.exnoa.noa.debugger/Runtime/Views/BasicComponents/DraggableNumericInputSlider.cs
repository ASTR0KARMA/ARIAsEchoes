...
{
    sealed class DraggableNumericInputSlider : MonoBehaviour, IPointerDownHandler
    {
        ...
        NoaDebuggerScrollableInputComponent _numericInput;

        public DragSliderEvent OnSliding = new();
        public UnityEvent OnBeginSlider = new();
        public UnityEvent OnEndSlider = new();

        public void Initialize(BlockableScrollRect parentScroll, NoaDebuggerScrollableInputComponent numericInput)
        {
            _parentScroll = parentScroll;
            _numericInput = numericInput;

            _numericInput.OnInputModeChanged -= _OnInputModeChanged;
            _numericInput.OnInputModeChanged += _OnInputModeChanged;
        ...
        {
            return distance >= DraggableNumericInputSlider.DragDirectionCheckDistance;
        }
    }
}
